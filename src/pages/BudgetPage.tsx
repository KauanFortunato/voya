...
export default function BudgetPage() {
  ...
  return (
    <main className="budget-page" id="main-content">
      <SubpageHeader kicker="Itália 2026" title="Orçamento" actionIcon={Plus} actionLabel="Adicionar despesa" onAction={() => setEditorOpen(true)} />
      ...
      {budget && <>
        <section className="budget-hero">
          <div className="budget-hero__top"><span><WalletCards size={18} />Orçamento familiar</span>{budget.canEditBudget && <button type="button" onClick={() => { setBudgetDraft(String(budget.trip.budgetAmount)); setBudgetEditing(true) }}><Pencil size={15} />Editar</button>}</div>
